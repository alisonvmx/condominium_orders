const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: '/porteiro/ControleUsuarios', component: () => import('src/pages/ControleUsuariosForPorteiroPage.vue') },
      { path: '/porteiro/ControleUsuarios/create', component: () => import('src/pages/form/FormUserCreateForPorteiroPage.vue') },
      { path: '/porteiro/ControleUsuarios/edit/:id', component: () => import('src/pages/form/FormUserEditForPorteiroPage.vue') },
      { path: '/porteiro/ControleEncomendas', component: () => import('pages/ControleEncomendasForPorteiroPage.vue') },
      ...
      { path: '/porteiro/ControleApartamentos', component: () => import('pages/ControleApartamentosForPorteiroPage.vue') },
