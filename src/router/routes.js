const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: '/porteiro/ControleUsuarios', component: () => import('src/pages/ControleUsuarios.vue') },
      { path: '/porteiro/ControleUsuarios/create', component: () => import('src/pages/form/FormUserCreate.vue') },
      { path: '/porteiro/ControleUsuarios/edit/:id', component: () => import('src/pages/form/FormUserEdit.vue') },
      { path: '/porteiro/ControleEncomendas', component: () => import('pages/ControleEncomendas.vue') },
      ...
      { path: '/porteiro/ControleApartamentos', component: () => import('pages/ControleApartamentos.vue') },
